...
Rscript step1_fitNULLGLMM.R     \
        ...
        --phenoCol=bmi \
        --covarColList=age,agesq,sex,CFTR_score,PIPS,PC1,PC2,PC3,PC4,PC5,PC6 \
        --qCovarColList=sex  \
        --sampleIDColinphenoFile=IID \
        --invNormalize=FALSE     \
        --traitType=quantitative        \
        --outputPrefix=Sens_both_scores/saige_step1_both \
        --nThreads=24	\
...
for ((number = start_number; number <= end_number; number++)); do
    ...
    Rscript step2_SPAtests.R        \
        ...
        --vcfField=DS   \
        --SAIGEOutputFile=Sens_both_scores/saige_step2_${number}_both.txt    \
        --chrom=chr${number}       \
        --minMAF=0.01 \
        --GMMATmodelFile=Sens_both_scores/saige_step1_both.rda \
        --varianceRatioFile=Sens_both_scores/saige_step1_both.varianceRatio.txt \
...
#         --vcfField=DS   \
#         --SAIGEOutputFile=Sens_both_scores/saige_step2_X_both.txt    \
#         --chrom=chrX       \
#         --minMAF=0.01 \
#         --GMMATmodelFile=Sens_both_scores/saige_step1_both.rda \
#         --varianceRatioFile=Sens_both_scores/saige_step1_both.varianceRatio.txt \
